...
public:
	...
	static G4Material* Parafina;// declarando materiales para modelamiento de Lecho fijo			     
        ...
        static G4Material* NiMo_Al2O3_15porciento;// declarando materiales para modelamiento de Lecho fijo
        static G4Material* NiMo_Al2O3_30porciento;// declarando materiales para modelamiento de Lecho fijo
        static G4Material* NiMo_Al2O3_45porciento;// declarando materiales para modelamiento de Lecho fijo
        static G4Material* NiMo_Al2O3_55porciento;// declarando materiales para modelamiento de Lecho fijo
        static G4Material* LechoFijo;// declarando materiales para modelamiento de Lecho fijo 
        static G4Material* LechoFijo_15porciento;// declarando materiales para modelamiento de Lecho fijo
	static G4Material* LechoFijo_30porciento;// declarando materiales para modelamiento de Lecho fijo			      
	static G4Material* LechoFijo_45porciento;// declarando materiales para modelamiento de Lecho fijo			      
        static G4Material* LechoFijo_55porciento;// declarando materiales para modelamiento de Lecho fijo
