...
//###################--------DATOS GEOMÈTRICOS DE LA TORRE CILÌNDRICA A MODELAR------------#################################
	...
	double RadioLecho = 200 * CLHEP::cm;// radio del cilindro catalizador
        ...
        double HeighLecho01=1200* CLHEP::cm; // Altura de lecho fijo 01 ( densidad normal )
        double HeighLecho02=0* CLHEP::cm; // Altura de lecho fijo 02 ( densidad incrementada )
...
{       // secciòn inerte 01
	...
	// secciòn de lecho con residuos - densidad incrementada
        ...
        if (incrLecho=1){HlogicBrick03 = new G4LogicalVolume(HsolidBrick03, Materials().LechoFijo_15porciento, "HLeadBrick03");}
